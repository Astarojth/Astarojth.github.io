...
\noindent
\textbf{Luo, H.}, Huang, H., Deng, Z., Liu, X., Chen, R., \& Liu, Z. (2024). BIGbench: A unified benchmark for social bias in text-to-image generative models based on multi-modal LLM. \textit{arXiv:2407.15240}.\\[4pt]
\noindent
...
-- Representative works: AgentAuditor (NeurIPS 2025), DynamicNER (EMNLP 2025), HAI-Eval, PrefIx (ACL 2026 Findings), AudioTrust (ICLR 2026), AudioStealer (ACL 2026 Findings).\\[-2pt]

\noindent
\textbf{LLM/Agent-as-a-Judge}\\
2024.11--present\\
New York University Abu Dhabi \& Nanyang Technology University, Prof. Hanan Salam, Dr. Xinfeng Li\\
-- Representative works: AgentAuditor (NeurIPS 2025), PrefIx (ACL 2026 Findings), BiasIG (IJCNN 2026), BIGbench.\\[-2pt]
...
-- Representative works: AgentAuditor (NeurIPS 2025), a full-stack safety survey for LLM(-agent) systems.\\[-2pt]

\noindent
\textbf{Human--Agent Collaboration}\\
2025.11--present\\
New York University Abu Dhabi, Prof. Hanan Salam\\
-- Representative works: HAI-Eval, PrefIx (ACL 2026 Findings).\\[-2pt]
...
-- Representative works: BiasIG (IJCNN 2026), FAIntbench (ICML-DMLR 2024), BIGbench, VersusDebias.\\[-2pt]

\noindent
\textbf{Audio Model Trustworthiness}\\
2024.11--present\\
Nanyang Technology University, Prof. XiaoFeng Wang \& Dr. Xinfeng Li\\
-- Representative works: AudioTrust (ICLR 2026), AudioStealer (ACL 2026 Findings).\\[2pt]

\noindent
\textbf{LLM-based Multilingual Information Extraction}\\
2024.7--present\\
Zhejiang University, Prof. Zuozhu Liu\\
-- Representative work: DynamicNER (EMNLP 2025).\\[-2pt]

\noindent
\textbf{Computer Vision}\\
2023.7--2023.11\\
Zhejiang University, Prof. Gaoang Wang\\
-- Representative work: UniAP (AAAI 2024).\\[2pt]
...
\begin{itemize}[topsep=3pt,itemsep=1pt]
  ...
  \item \textbf{Engineering}: Completed core courses in machine learning, computer systems, algorithms, etc.
