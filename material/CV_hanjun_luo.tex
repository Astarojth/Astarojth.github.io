...
\noindent
Wang, K., Zhang, G., Zhou, Z., Wu, J., Yu, M., Zhao, S., Yin, C., Fu, J., Yan, Y., \textbf{Luo, H.}, \textit{et al.} (2025). A comprehensive survey in LLM(-agent) full stack safety: Data, training and deployment. \textit{arXiv:2504.15585}.\\[6pt]
...
-- Representative works: HAI-Eval and PrefIx (ACL 2026 Findings).\\
...
-- Representative works: BiasIG (IJCNN 2026), FAIntbench (ICML-DMLR 2024), BIGbench, and VersusDebias.\\

\noindent
\textbf{Audio Model Trustworthiness}\\
2024.11--present\\
Nanyang Technology University, Prof. XiaoFeng Wang \& Dr. Xinfeng Li\\
-- Representative works: AudioTrust (ICLR 2026), AudioStealer (ACL 2026 Findings).\\[4pt]
